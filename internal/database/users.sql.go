...
SELECT feed_follows.id, feed_follows.created_at, feed_follows.updated_at, feed_follows.feed_id, feed_follows.user_id, users.name AS user_name, feeds.name AS feed_name FROM feed_follows
INNER JOIN users
